...
namespace vision {
    namespace vslam {
        ...
        /**
        * @brief Perform 3-D reconstruction from a homography matrix between two image views.
        *
        ...
        * @param[out] medianDepth, a double value representing the median depth of the filtered 3-D world points.
